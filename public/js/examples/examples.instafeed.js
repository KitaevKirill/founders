...
(function($) {
    ...
    var clientId    = '20ed6da82f1c4b619f6009baf7017229',
        accessToken = '252572611.1677ed0.50e18d1b40a241a9b861f6db2537352d';
            ...
            template:
                '<div class="col-6 col-xl-4 px-0">'+ 
                    '<a href="{{link}}" target="_blank">' +
                        '<span class="thumb-info thumb-info-lighten thumb-info-centered-info thumb-info-no-borders">' +
                            '<span class="thumb-info-wrapper">' +
                                '<img src="{{image}}" class="img-fluid img-insta" alt="{{caption}}" />' +
                            '</span>' +
                        '</span>' +
                    '</a>' +
                '</div>',
