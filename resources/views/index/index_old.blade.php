			...
			<div class="container py-2 mt-4">
				...
				<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
					<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
						...
						<div class="col-md-6 col-lg-4 isotope-item p-1 logos">
							<div class="portfolio-item">
								<a data-fancybox="gallery" href="img/test/blog_img1.png">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="img/test/blog_img5.png" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
						...
						<div id="mycontainer" style="display:none;">
								...
								<div class="mosaicflow__item">
									<a data-fancybox="gallery" href="../img/test/blog_img2.png">
										<img class="img-responsive" src="../img/test/blog_img2.png" alt="">
									</a>
								</div>
								<div class="mosaicflow__item">
									<a data-fancybox="gallery" href="../img/test/blog_img3.png">
										<img class="img-responsive" src="../img/test/blog_img3.png" alt="">
									</a>
								</div>
								<div class="mosaicflow__item">
									<a data-fancybox="gallery" href="../img/test/blog_img4.png">
										<img class="img-responsive" src="../img/test/blog_img4.png" alt="">
									</a>
								</div>
								<div class="mosaicflow__item">
									<a data-fancybox="gallery" href="../img/test/blog_img5.png">
										<img class="img-responsive" src="../img/test/blog_img5.png" alt="">
									</a>
								</div>
